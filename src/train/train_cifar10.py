"""
CIFAR10 Activation-Driven SNN Baseline Training
"""
import argparse
import os
import sys
...
from spikingjelly.activation_based.surrogate import ATan, Sigmoid
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='CIFAR10 Baseline SNN Training')
    ...
    parser.add_argument('--surrogate', default='Sigmoid', type=str, help='surrogate function')
    parser.add_argument('--surrogate_beta', default=4.0, type=float, help='surrogate beta parameter')
    ...
    parser.add_argument('--data_dir', default='./datasets/CIFAR10', type=str, help='dataset directory')
    ...
    parser.add_argument('--autoaug', action='store_true', help='use AutoAugment')
